 ...
 **labelType** | **String**| The type of labels requested.  | [enum: BARCODE_2D, UNIQUE, PALLET]
 ...
 **pageSize** | **Integer**| The page size for paginating through the total packages&#39; labels. This is a required parameter for Non-Partnered LTL Shipments. Max value:1000. | [optional]
 **pageStartIndex** | **Integer**| The page start index for paginating through the total packages&#39; labels. This is a required parameter for Non-Partnered LTL Shipments. | [optional]
