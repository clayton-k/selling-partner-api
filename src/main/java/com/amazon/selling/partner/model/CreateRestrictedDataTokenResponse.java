...
public class CreateRestrictedDataTokenResponse {
  ...
  **/
  @ApiModelProperty(value = "A Restricted Data Token (RDT). This is a short-lived access token that authorizes you to access the restricted resources that you specified. Pass this value with the x-amz-access-token header when making subsequent calls to these restricted resources.")
