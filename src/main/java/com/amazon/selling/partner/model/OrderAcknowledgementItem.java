...
import com.amazon.selling.partner.model.ItemQuantity;
import com.amazon.selling.partner.model.Money;
import com.amazon.selling.partner.model.OrderItemAcknowledgement;
...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2021-09-03T11:47:59.623+08:00")
public class OrderAcknowledgementItem {
  ...
  **/
   ...
   * @return netCost
  **/
  @ApiModelProperty(required = true, value = "The cost to Amazon, which should match the cost on the invoice. This is a required field. If this is left blank the file will reject in Amazon systems. Price information should not be zero or negative. Indicates a net unit price.")
