...
import com.amazon.selling.partner.model.catalog.items.ItemSalesRank;
...
public class ItemSalesRanksByMarketplace {
  ...
  private List<ItemSalesRank> ranks = new ArrayList<>();
  ...
  **/
   ...
   * @return ranks
  **/
  @ApiModelProperty(required = true, value = "Sales ranks of an Amazon catalog item for an Amazon marketplace.")
