...
import com.amazon.selling.partner.model.catalog.items.Item;
import com.amazon.selling.partner.model.catalog.items.Pagination;
import com.amazon.selling.partner.model.catalog.items.Refinements;
...
public class ItemSearchResults {
  ...
  **/
  @ApiModelProperty(required = true, value = "The estimated total number of products matched by the search query (only results up to the page count limit will be returned per request regardless of the number found).  Note: The maximum number of items (ASINs) that can be returned and paged through is 1000.")
