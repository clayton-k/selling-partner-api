...
import com.amazon.selling.partner.model.vendor.shipments.Expiry;
import com.amazon.selling.partner.model.vendor.shipments.Money;
...
public class ItemDetails {
  ...
  **/
  @ApiModelProperty(value = "The Amazon purchase order number for the shipment being confirmed. If the items in this shipment belong to multiple purchase order numbers that are in particular carton or pallet within the shipment, then provide the purchaseOrderNumber at the appropriate carton or pallet level. Formatting Notes: 8-character alpha-numeric code.")
